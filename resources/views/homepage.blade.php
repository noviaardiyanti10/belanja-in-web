          ...
          <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
            ...
            <form class="form-inline mx-auto" role="search">
                <div class="input-group">
                    <input class="form-control" type="search" placeholder="Cari parfum kesukaanmu" aria-label="Search">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="desc text-center mt-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut commodo in vestibulum, sed dapibus tristique nullam.</p>
